...
from experiments.core_discovery.candidates import METHODS
from experiments.core_discovery.data import HeroData, write_json
from experiments.core_discovery.discover import fit_method, source_fingerprints
