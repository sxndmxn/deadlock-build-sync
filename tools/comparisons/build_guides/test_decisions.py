...
from tools.comparisons.build_guides.assemble import assemble
from tools.comparisons.build_guides.audit import audit_decisions
from tools.comparisons.build_guides.decisions import attach_decisions, decisions_for
from tools.comparisons.build_guides.paths import plan
from tools.comparisons.build_guides.purposes import purpose
from tools.comparisons.build_guides.render import markdown
from tools.comparisons.build_guides.schema import adapt_legacy
from tools.comparisons.build_guides.test_build_guides import (
    evidence_fixture,
    graph_fixture,
    guide_fixture,
    row_fixture,
